...
def show_start_info(screen):
    font = pygame.font.SysFont('msgothic.ttc', 40)
    tip = font.render('Press any key to enter the game~~', True, (65, 105, 155))
    gamestart = pygame.image.load('E:\\image\\gamestart.jpg')
    screen.blit(gamestart, (160, 110))
    screen.blit(tip, (155, 550))
    pygame.display.update()
...
def show_gameover_info(screen):
    font = pygame.font.SysFont('msgothic.ttc', 40)
    tip = font.render('Press Q or ESC to exit the game and press \n any key to restart the game~', True, (65, 105, 225))
    gamestart = pygame.image.load('E:\\image\\gamestart.jpg')
    screen.blit(gamestart, (160, 110))
    screen.blit(tip, (20, 550))
    pygame.display.update()
...
def draw_score(screen, score):
    font = pygame.font.SysFont('msgothic.ttc', 30)
